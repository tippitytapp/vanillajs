...
function rockPaperScissors(playerChoice){
    ...
    console.log(`You chose: ${playerChoice}, Computer Chose: ${choiceString}`)
    if (playerChoiceNum === choice) {

        console.log("Draw")
    } else if(playerChoiceNum === 0 && choice === 1){

        console.log("You lost")
    } else if(playerChoiceNum === 0 && choice === 2) {

        console.log("You win")
    } else if(playerChoiceNum === 1 && choice === 2){

        console.log("You Lost")
    } else if(playerChoiceNum === 1 && choice === 0) {

        console.log("You win")
    } else if(playerChoiceNum === 2 && choice === 0){

        console.log("You Lost")
    } else if(playerChoiceNum === 2 && choice === 1) {
...
rl.question("Lets Play Rock, Paper, Scissors: ", (answer) => {
    console.log(rockPaperScissors(answer));
